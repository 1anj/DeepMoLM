...
if "mol_3d_dataset" not in DATASETS:
    DATASETS["mol_3d_dataset"] = {
        "_target_": "llava.data.mol_dataset.MolDataset",
        "data_path": "./data/3d-mol-dataset",
        "max_atoms": 256,
    }

MIXTURES = register_mixtures()
MIXTURES.setdefault("mol_3d_mix", ["mol_3d_dataset"])
