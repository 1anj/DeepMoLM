#!/bin/bash
# Stage 2 Specialist: PubChemQC Property
# Fine-tune on a single dataset and evaluate on test/valid.

SPECIALIST_NAME="pubchemqc_prop"
TRAIN_DATASET="e3fp_pubchemqc_prop_train"
TEST_DATASET="e3fp_pubchemqc_prop_test"
VALID_DATASET="e3fp_pubchemqc_prop_valid"
