#!/bin/bash
# Stage 2 Specialist: PubChem Compound
# Fine-tune on a single dataset and evaluate on test/valid.

SPECIALIST_NAME="pubchem_com"
TRAIN_DATASET="e3fp_pubchem_com_train"
TEST_DATASET="e3fp_pubchem_com_test"
VALID_DATASET="e3fp_pubchem_com_valid"
