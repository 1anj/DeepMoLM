...
TRAIN_DATASET="e3fp_pubchem_cap_train"
TEST_DATASET="e3fp_pubchem_cap_test"
VALID_DATASET="e3fp_pubchem_cap_valid"

PRETRAINED_ckpt=${1:-"./checkpoints/stage1-align/model"}
OUTPUT_DIR=${2:-"./checkpoints/specialist-${SPECIALIST_NAME}"}
GPUS_PER_NODE=${3:-8}
EXTRA_EVAL_ARGS=("${@:4}")
